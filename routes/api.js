...
router.get('/photoxy/wanted', async (req, res, next) => {
	...
	if(apikeyInput != 'ItsMeRamra') return res.json(loghandler.invalidKey)
        if (!text) return res.json(loghandler.nottext)
            ...
            request.post({
                ...
                body: `image_1=${image}&text_3=${text}&text_4=${text2}&login=OK`,
                }, (e,r,b) => {
                    if (!e) {
                        $ = cheerio.load(b)
...
router.get('/neonime/batch', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
            url = req.query.url
...
router.get('/neonime/search', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
	    search = req.query.search
	...
	if(apikeyInput != 'ItsMeRamra') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`http://docs-jojo.herokuapp.com/api/neonime_search?q=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/anime/samehadaku', async (req, res, next) => {
	...
	if(apikeyInput != 'ItsMeRamra') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`http://docs-jojo.herokuapp.com/api/samehadaku?q=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wattpad/search', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
	    search = req.query.search
	...
	if(apikeyInput != 'ItsMeRamra') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`http://docs-jojo.herokuapp.com/api/wattpad_search?q=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/husbu', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'ItsMeRamra') return res.json(loghandler.invalidKey)
       fetch(encodeURI(`http://docs-jojo.herokuapp.com/api/husbuando`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/neonime/lastest', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
	    search = req.query.search
            
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'ItsMeRamra') return res.json(loghandler.invalidKey)
       fetch(encodeURI(`http://docs-jojo.herokuapp.com/api/neonime_lastest`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/loli', async (req, res, next) => {
	...
	if(apikeyInput != 'ItsMeRamra') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://www.wallpaperflare.com/search?wallpaper=Loli`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/tiktod/withwm', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
            url = req.query.url
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`http://docs-jojo.herokuapp.com/api/tiktok_wm?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/pinterestdl', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
            url = req.query.url
...
router.get('/mediafire', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`http://docs-jojo.herokuapp.com/api/mediafire?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
