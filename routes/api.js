...
var creatorList = ['Raa','Rara','Lolkill','LoliKillers','RaraAfrianty'];
...
router.get('/random2/blowjob', async (req, res, next) => {
...
router.get('/random2/trap', async (req, res, next) => {
...
router.get('/random2/neko', async (req, res, next) => {
...
router.get('/random2/waifu', async (req, res, next) => {
...
router.get('/random/dance', async (req, res, next) => {
...
router.get('/random/poke', async (req, res, next) => {
...
router.get('/random/wink', async (req, res, next) => {
...
router.get('/random/happy', async (req, res, next) => {
...
router.get('/random/kill', async (req, res, next) => {
...
router.get('/random/slap', async (req, res, next) => {
...
router.get('/random/glomp', async (req, res, next) => {
...
router.get('/random/nom', async (req, res, next) => {
            

       fetch(encodeURI(`https://api.waifu.pics/sfw/nom`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/handhold', async (req, res, next) => {
...
router.get('/random/highfive', async (req, res, next) => {
...
router.get('/random/wave', async (req, res, next) => {
...
router.get('/random/smile', async (req, res, next) => {
...
router.get('/random/yeet', async (req, res, next) => {
...
router.get('/random/bonk', async (req, res, next) => {
...
router.get('/random/smug', async (req, res, next) => {
...
router.get('/random/pat', async (req, res, next) => {
...
router.get('/random/lick', async (req, res, next) => {
...
router.get('/random/kiss', async (req, res, next) => {
...
router.get('/random/awoo', async (req, res, next) => {
...
router.get('/random/hug', async (req, res, next) => {
...
router.get('/random/cry', async (req, res, next) => {
...
router.get('/random/cuddle', async (req, res, next) => {
...
router.get('/random/bully', async (req, res, next) => {
...
router.get('/random/shinobu', async (req, res, next) => {
...
router.get('/random/quotesnime', async (req, res, next) => {
       ...
       fetch(encodeURI(`https://animechan.vercel.app/api/random`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/infomakeup', async (req, res, next) => {
            var query = req.query.query
            
    if (!query) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter query"})

       fetch(encodeURI(`http://makeup-api.herokuapp.com/api/v1/products.json?brand=${query}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/ipinfo', async (req, res, next) => {
    ...
    if (!query) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter query"})
       ...
       fetch(encodeURI(`https://ipinfo.io/${query}/geo`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/quotes/character', async (req, res, next) => {
            query = req.query.query
            
    if (!query) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter query"})

       fetch(encodeURI(`https://animechan.vercel.app/api/quotes/character?name=${query}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/quotes/anime', async (req, res, next) => {
    ...
    if (!query) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter query"})
       ...
       fetch(encodeURI(`https://animechan.vercel.app/api/quotes/anime?title=${query}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/base', async (req, res, next) => {
	var type = req.query.type,
		...
		if (apikeyInput != 'ItsMeRamra') return res.json(loghandler.invalidKey)
...
router.get('/textmaker3/orchids', async (req, res, next) => {
...
router.get('/textmaker3/petterns', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/silk', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/sweetcandy', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/embroidery', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/smoke', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/woodblock', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/cemetery', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/luxury', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/8bit', async (req, res, next) => {
             var text = req.query.text,
...
router.get('/textmaker3/harrypotter', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/wooden', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/butterfly', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/watermelon', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/striking', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker3/metalic', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/chrome', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/flaming', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/generator', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/textstar', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/glowrainbow', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/gradient', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/whitecube', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/candy', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/vintage', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/glowing', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/camouflage', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/nature', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/underwater', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/nature2', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/metal', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/woodboards', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/rainbow', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/onrainbow', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/love', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker2/undergrass', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker/funcup', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker/romantic', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker/cup', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker/shadow', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
...
router.get('/textmaker/grafity', async (req, res, next) => {
             var text = req.query.text,
             apikeyInput = req.query.apikey;
                ...
                body: `text_1=${text}&text_2=${text2}&login=OK`,
                    ...
                    if (!e) {
                        ...
                        $(".thumbnail").find("img").each(function() {
                            h = $(this).attr("src")
                            var result = "https://photooxy.com/"+h
                            fetch(encodeURI(`https://api.imgbb.com/1/upload?expiration=120&key=32d7511de891a11786a8e73a8e346afd&image=${result}&name=${randomTextNumber}`))
                                .then(response => response.json())
                                .then(data => {
                                    var urlnya = data.data.url,
                                        delete_url = data.data.delete_url;
...
router.get('/facebook/downloader', async (req, res, next) => {
            var url = req.query.url
...
router.get('/jadwalshalat', async (req, res, next) => {
       ...
       fetch(encodeURI(`https://time.siswadi.com/timezone/?address=${kota}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hitungmundur', async (req, res, next) => {
	    date = req.query.tanggal
	    month = req.query.bulan
	    years = req.query.tahun
            
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`https://api-self.herokuapp.com/api/hitungmundur?tanggal=${date}&bulan=${month}&tahun=${years}`))
        .then(response => response.json())
        .then(data => {
        var data = data;
             res.json({
                 result: {
					 status: `${data.status}`, creator: `${creator}`, time: `$(data.result}`
				 }
             })
         })
         .catch(e => {
...
router.get('/anime/kusonime', async (req, res, next) => {
	...
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`https://trace.moe/api/search?url=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/anime/scan', async (req, res, next) => {
	    var url = req.query.url
            
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter pencarian"})
       fetch(encodeURI(`https://api.jikan.moe/v3/search/anime?q=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/jikan/search', async (req, res, next) => {
	    var search = req.query.search
            
    if (!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter pencarian"})
       fetch(encodeURI(`https://api.jikan.moe/v3/search/anime?q=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kuis/caklontong', async (req, res, next) => {
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/LoliKillers/Ramra-Database/master/game/caklontong.json`))
        .then(response => response.json())
        .then(data => {
        var result = data[Math.floor(Math.random() * data.length)];
             res.json({
...
router.get('/kuis/tebakgambar', async (req, res, next) => {
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/LoliKillers/Zhirrr-Database/main/tebakgambar.json`))
        .then(response => response.json())
        .then(data => {
...
router.get('/simsimi', async (req, res, next) => {
    ...
    if (!query) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter pertanyaan"})
       ...
       fetch(encodeURI(`https://fdciabdul.tech/api/ayla/?pesan=${query}`))
        ...
        var dta = data;
             res.json({
             	author: 'Rara Afrianty',
					 query: `${dta.tanya}`, answer: `${dta.jawab}`, message_dev: 'Gunakan sebaik-baiknya jangan di spam yak :)'
             })
         })
         .catch(e => {
         	res.json(loghandler.error)
...
router.get('/mediafire', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://videfikri.com/api/mediafire/?query=${url}`))
        .then(response => response.json())
        .then(data => {
        var data = data;
             res.json({
             	author: `${creator}`, status: 'false', filename: `${data.result.filename}`, size: `${data.result.size}`, uploaded: `${data.result.uploaded_on}`, url: `${data.result.download}`
             })
         })
         .catch(e => {
         	res.json(loghandler.error)
    ...
    if (!username) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter username"})
       ...
       fetch(encodeURI(`https://videfikri.com/api/stalktwit/?username=${username}`))
        ...
        var data = data;
             res.json({
				 result: {
					 status: `${data.result.status}`, creator: `${creator}`, username: `${data.result.username}`, fullname: `${data.result.full_name}`, followers: `${data.result.followers}`, following: `${data.result.following}`, tweets: `${data.result.tweets}`, thumbnail: `${data.result.profile}`, joined: `${data.result.joined_on}`, banner: `${data.result.profile_banner}`
				 }
             })
         })
         .catch(e => {
...
router.get('/github/stalk', async (req, res, next) => {
    ...
    if (!username) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter username"})
       ...
       fetch(encodeURI(`https://videfikri.com/api/github/?username=${username}`))
        .then(response => response.json())
        .then(data => {
        var data = data;
             res.json({
				 result: {
					 creathor: `${creator}`, status: `${data.result.status}`, id: `${data.result.id}`, username: `${data.result.username}`, profile_pic: `${data.result.profile_pic}`, fullname: `${data.result.fullname}`, company: `${data.result.company}`, bio: `${data.result.biografi}`, hireable: `${data.result.hireable}`, email: `${data.result.email}`, location: `${data.result.location}`, followers: `${data.result.followers}`, following: `${data.result.following}`, public_repo: `${data.result.public_repository}`, gists: `${data.result.public_gists}`, join: `${data.result.joined_on}`, last_update: `${data.result.last_updated}`, url_profile: `${data.result.profile_url}`
				 }
             })
         })
         .catch(e => {
...
router.get('/myanimelist', async (req, res, next) => {
            search = req.query.search
...
router.get('/random/kucing', async (req, res, next) => {
       ...
       fetch(encodeURI(`https://thatcopy.pw/catapi/rest/`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/pinterest/search', async (req, res, next) => {
            var search = req.query.search
...
router.get('/yutub/play', async (req, res, next) => {
    ...
    if (!video) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter video"})
       ...
       fetch(encodeURI(`https://videfikri.com/api/ytplayv2/?query=${video}`))
        .then(response => response.json())
        .then(data => {
        var data = data;
             res.json({
				 result: {
					 status: `${data.result.status}`, creator: `${creator}`, title: `${data.result.title}`, channel: `${data.result.channel}`, id: `${data.result.id}`, thumbnail: `${data.result.thumbnail}`, views: `${data.result.views}`, published: `${data.result.published_on}`, size: `${data.result.size}`,duration: `${data.result.duration}`, url: `${data.result.url}`, source: `${data.result.source}`, description: `${data.result.description}`
				 }
             })
         })
         .catch(e => {
...
router.get('/yutub/playmp4', async (req, res, next) => {
    ...
    if (!video) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter video"})
       ...
       fetch(encodeURI(`https://videfikri.com/api/playmp4v2/?query=${video}`))
        .then(response => response.json())
        .then(data => {
        var data = data;
             res.json({
				 result: {
					 status: `${data.result.status}`, creator: `${creator}`, title: `${data.result.judul}`, id: `${data.result.id}`, channel: `${data.result.channel}`, published: `${data.result.published_on}`, views: `${data.result.views}`, size: `${data.result.size}`, duration: `${data.result.duration}`, source: `${data.result.source}`, thumbnail: `${data.result.imgUrl}`, url: `${data.result.urlVideo}`, description: `${data.result.description}`
				 }
             })
         })
         .catch(e => {
